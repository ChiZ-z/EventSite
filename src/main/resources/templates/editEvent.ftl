...
<div class="uk-container uk-container-center" style="padding-top: 50px">
    <form method="post" enctype="multipart/form-data">
        <fieldset class="uk-fieldset">
            ...
            <div class="uk-margin" >
                ...
                <div uk-alert>How many people can come?<input class="uk-input " type="number" name="amount" placeholder="${event.amountAll}" value="${event.amountAll}"></div>
            </div>
    ...
    <div>
        <label><input  class="uk-checkbox" type="checkbox" name="${artist}" ${event.artists?seq_contains(artist)?string("checked", "")} />${artist}</label>
    </div>
            </#list>
